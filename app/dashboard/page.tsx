      ...
      <header className="w-full max-w-7xl mx-auto px-6 py-6 flex items-center justify-between border-b border-slate-900 z-10">
        ...
        <div className="flex items-center gap-6">
          ...
          <form action={signOut}>
            <button
              type="submit"
              className="text-xs font-semibold px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 text-rose-400 hover:bg-rose-500/10 hover:border-rose-500/30 transition-all duration-200"
            >
              Sign Out
            </button>
          </form>
