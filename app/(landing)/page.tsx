...
export default function LandingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 px-6 text-center">
      ...
      <div>
        <h1 className="text-2xl font-bold text-ink">HatidDok</h1>
      ...
      <button
        ...
        className="w-full max-w-xs rounded-xl bg-primary py-3 text-base font-semibold text-white shadow-sm active:opacity-90"
      >
        Sugdan / Get Started
      </button>
    </div>
